###########################################################################
# Helper functions to run regression simulations
...
experiment_poisson = function(para_vary){
  ...
  # Choose one of these depending on whether your computer supports multiprocessing or not. 
...
# Find knots from fitted trend filter object by examining where the discrete derivatives are close to 0
